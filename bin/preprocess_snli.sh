...
# Convert to h5 files
python bin/pack_to_hdf5.py $DATA_DIR/raw/snli_1.0/snli_1.0_train.txt $DATA_DIR/snli/train.h5 --lowercase=False --type=snli
python bin/pack_to_hdf5.py $DATA_DIR/raw/snli_1.0/snli_1.0_dev.txt $DATA_DIR/snli/valid.h5 --lowercase=False --type=snli
python bin/pack_to_hdf5.py $DATA_DIR/raw/snli_1.0/snli_1.0_test.txt $DATA_DIR/snli/test.h5 --lowercase=False --type=snli
